...
class MultipleUserMultipleAskRequest extends Simulation {
  ...
  val feeder1: RecordSeqFeederBuilder[String] = csv("loginMultipleUsers.csv").queue
  val queueSize1: IndexedSeq[Record[String]] = feeder1.records
  println("Processing " + queueSize1.toString + " records from loginMultipleUsers.csv file ")

  val feeder2: RecordSeqFeederBuilder[String] = csv("questions.csv").queue
  val queueSize2: IndexedSeq[Record[String]] = feeder2.records
